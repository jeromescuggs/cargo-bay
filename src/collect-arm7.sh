...
for i in $(find . -mindepth 1 -maxdepth 1 -type d); do
	...
	cd "$i" 
	echo "collecting ${PWD##*/}" 
	cp target/armv7-unknown-linux-gnueabihf/release/${PWD##*/} ../../bin/arm7
    cd ..;
done
...
if [[ -d ./bottom ]]; then
    ...
    cp $CUR_DIR/bottom/target/armv7-unknown-linux-gnueabihf/release/btm ../bin/arm7
fi 
